...
-- PROFILES
-- Decisão de papéis (Fase 2): mantidos apenas 'member' e 'admin'.
-- O papel de treinador é representado por 'admin'; nenhum código depende de 'treinador'.
...
-- Correção da auditoria: sem esta policy, "remover membro" falhava silenciosamente.
