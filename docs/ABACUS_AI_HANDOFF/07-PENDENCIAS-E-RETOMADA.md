...
Próxima ação exata: publicar a branch, abrir/mesclar a PR, validar o deployment de produção e registrar os IDs finais neste pacote. Os gates locais já passaram: lint, TypeScript, 70 unitários, build de 40 rotas, 20 asserções pgTAP e 28 cenários Playwright em desktop/mobile.
