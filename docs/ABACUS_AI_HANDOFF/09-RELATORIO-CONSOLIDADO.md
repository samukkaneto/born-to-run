...
Checkpoint de release: PR draft `#21`, commit `ec35108`, GitHub Actions `31461532992` integralmente verde e preview Vercel `dpl_H9fR4oKqDuwqF51unFTCs3jBt7kq` `READY`. Login e ativo de marca responderam `200`, sem runtime error no período auditado. Merge e auditoria de produção ainda pendentes neste registro.
