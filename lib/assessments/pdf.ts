...
export async function buildAssessmentPdf(data: AssessmentPdfData) {
  ...
  pageTwo.drawText('Gordura', { x: 230, y: 347, size: 6.5, font: regular, color: muted })
  pageTwo.drawText(measurement(data.segment_trunk_fat_pct, '%'), { x: 230, y: 333, size: 13, font: bold, color: red })
  pageTwo.drawText('Músculo', { x: 312, y: 347, size: 6.5, font: regular, color: muted })
  pageTwo.drawText(measurement(data.segment_trunk_muscle_kg, ' kg'), { x: 312, y: 333, size: 11, font: bold, color: green })
