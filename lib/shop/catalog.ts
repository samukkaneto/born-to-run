...
export const catalogProducts: CatalogProduct[] = [
  product({
    ...
    colorImages: { [colors.carbon.name]: '/shop-preview/camiseta-tecnica-carbono-catalogo.png' },
  ...
  product({
    ...
    colorImages: { [colors.carbon.name]: '/shop-preview/regata-performance-carbono-catalogo.png' },
  ...
  product({
    ...
    colorImages: { [colors.pink.name]: '/shop-preview/top-feminino-rosa-catalogo.png' },
  ...
  product({
    ...
    colorImages: { [colors.carbon.name]: '/shop-preview/short-corrida-carbono-catalogo.png' },
  ...
  product({
    ...
    colorImages: { [colors.blue.name]: '/shop-preview/manga-longa-azul-catalogo.png' },
