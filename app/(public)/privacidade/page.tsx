  ...
  return (
    <article className="container-main py-16 sm:py-20">
      <div className="mx-auto max-w-3xl space-y-9">
        ...
        <LegalSection title="Visibilidade na equipe"><p>Nome, avatar, bio, cidade, objetivo e conteúdo publicado podem ser vistos por integrantes ativos. Observações administrativas e metadados de revisão não são expostos aos demais membros. Treinos atribuídos e avaliações de bioimpedância são privados: cada atleta acessa somente os próprios registros, e apenas o treinador responsável pode criar ou alterar essas informações.</p></LegalSection>
