  ...
  return (
    <section className="container-main py-16 sm:py-20">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-stone-600">Instale a experiência web no seu dispositivo para abrir com ícone próprio e sem a moldura do navegador. Esta versão é uma PWA; o aplicativo Android nativo e seu APK serão uma etapa posterior.</p>
